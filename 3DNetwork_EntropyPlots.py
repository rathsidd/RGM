...
upperlimit_list=createUpperLimitList(lowerlimit,10,2)
#framesandlimits_entropies=np.random.rand(2,len(upperlimit_list))
#hydrogenbonds_array=[np.linspace(1,80,len(upperlimit_list)),np.linspace(1,80,len(upperlimit_list))]
